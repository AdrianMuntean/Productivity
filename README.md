...
A repo which contains tips and tricks for productivity. This includes, but not limited to:
  ...
  * MacOs [shortcuts](https://github.com/AdrianMuntean/Productivity/Linux/blob/master/Mac/Shortcuts.md) and [tools](https://github.com/AdrianMuntean/Productivity/Linux/blob/master/Mac/Tools.md)
